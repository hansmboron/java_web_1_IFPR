				...
				<table class="table table-condensed table-striped">
					...
					<c:forEach var="f" items="${fornecedores}">
						<tr>
							...
							<td>${f.razaoSocial}</td>
							<td>${f.cnpj}</td>
							<td><a href="FornecedorServlet?pagina=list&acao=update&id=${f.id}">Atualizar</a></td>
							<td><a href="FornecedorServlet?pagina=list&acao=delete&id=${f.id}">Apagar</a></td>
						</tr>
					</c:forEach>
				</table>
				<p>${mensagem}</p>
